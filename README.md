...
* **API ключ для sadcaptcha.com** — укажите в переменной окружения или в конфигурационном файле (в зависимости от реализации). В файл proxies.txt указать ipv4 прокси в формате ip:port:user:password или ip:port
---
